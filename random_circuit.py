...
# obtain a copy of this license at https://github.com/Qiskit/qiskit/blob/main/LICENSE.txt
...
def get_random_circuit(
    ...
    from the set of gates specified`. For example:
    ...
    .. plot::
       ...
       circ = random_circuit(2, 2, standard_gates, measure=True)
       circ.draw(output='mpl')

    Args:
        num_qubits (int): number of quantum wires
        depth (int): layers of operations (i.e. critical path length)
        gate_set (dict): keys specified as '(n)q' for list of single-qubit (1q) and multi-qubit (2q, 3q, 4q) gates
